...
def predict(img_path):
    ...
    if class_test_img == "Sehat" and score_test_img < 0.5:
        ...
        DESC["desc"][1][
            "explain"
        ] = "Daun padi terdeteksi sehat namun dengan score kepercayaan yang rendah. Ada kemungkinan padi mengidap penyakit."
        DESC["desc"][1]["solution"] = [
            CLASS_DATA[all_score[i]] + ": " + str(predict[0][all_score[i]])
